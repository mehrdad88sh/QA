*** Settings ***
Documentation              Register and login Alunak
...
Register Request Valid
    ...
    Post                    /v2/auth/register      {"cellphone": "${Random_Number}", "user_type": "real-estate"}
...
Register Request Invalid Phone Number
    ...
    Set Headers             {"Authorization": "Basic dHJ1bXBldDpuZXdzaXRl"}
    Post                    /v2/auth/register      {"cellphone": "123456789", "user_type": "real-estate"}
